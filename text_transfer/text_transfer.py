...
class text_transfer(object):
    ...
    def get_initial_prompt(self):
        ...
        initial_prompt = "请作为兵棋推演游戏的玩家，设想一个陆战作战场景，我方为红方，拥有坦克、步兵战车、自行迫榴炮、无人突击车和无人机、导弹发射车等装备，步兵下车后作战，我方需要攻取位于经纬度坐标(2.71,39.76)的夺控点，要将陆战装备移动到夺控点处并消灭夺控点附近敌人，地图范围为经度2.60到2.80，纬度范围为39.65到39.85，导弹发射车不能机动。在每一步，我将告诉你敌我态势和其他信息，并由你来尝试生成作战指令。"
        # 还需要一些描述地图的prompt
